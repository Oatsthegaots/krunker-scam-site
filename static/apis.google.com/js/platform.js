(function() {
    ...
    q("Symbol", function(a) {
        ...
        b.prototype.toString = function() { return this.ca };
    ...
    q("Symbol.iterator", function(a) {
        ...
        for (var b = "Array Int8Array Uint8Array Uint8ClampedArray Int16Array Uint16Array Int32Array Uint32Array Float32Array Float64Array".split(" "), c = 0; c < b.length; c++) { var d = da[b[c]]; "function" === typeof d && "function" != typeof d.prototype[a] && ba(d.prototype, a, { configurable: !0, writable: !0, value: function() { return ha(aa(this)) } }) }
        return a
    });
    var ha = function(a) {
            a = { next: a };
    ...
    q("Array.prototype.keys", function(a) { return a ? a : function() { return ja(this, function(b) { return b }) } });
    ...
    q("String.prototype.includes", function(a) { return a ? a : function(b, c) { return -1 !== ia(this, b, "includes").indexOf(b, c || 0) } });
    ...
    */
    var t = this || self,
        ...
        ua = function(a) {
            ...
            try { b = c.createPolicy(a, { createHTML: ta, createScript: ta, createScriptURL: ta }) } catch (d) { t.console && t.console.error(d.message) }
            return b
        };
    ...
    function xa(a, b, c, d) { var e = "Assertion failed"; if (c) { e += ": " + c; var f = d } else a && (e += ": " + a, f = b); throw new wa("" + e, f || []); }
    var ya = function(a, b, c) { a || xa("", null, b, Array.prototype.slice.call(arguments, 2)); return a },
        za = function(a, b) { throw new wa("Failure" + (a ? ": " + a : ""), Array.prototype.slice.call(arguments, 1)); },
        Aa = function(a, b, c) { "string" !== typeof a && xa("Expected string but got %s: %s.", [ka(a), a], b, Array.prototype.slice.call(arguments, 2)) };
    ...
    */
    ...
    var Ia = function(a) {
        ...
        Ha = {},
        Ga = {};
    var z = function(a, b) { this.P = b === Ja ? a : "" };
    z.prototype.F = !0;
    ...
    Oa.prototype.D = function() { return this.O.toString() };
    Oa.prototype.toString = function() { return this.O.toString() };
    var Pa = function(a, b) {
        a: {
            try {
                ...
                d = d || t;
                if (d.Element && d.Location) { var e = d; break a }
            } catch (g) {}
            e = null
        }
    ...
    var Ra = function(a, b) { Ea(b, function(c, d) { c && "object" == typeof c && c.F && (c = c.D()); "style" == d ? a.style.cssText = c : "class" == d ? a.className = c : "for" == d ? a.htmlFor = c : Qa.hasOwnProperty(d) ? a.setAttribute(Qa[d], c) : 0 == d.lastIndexOf("aria-", 0) || 0 == d.lastIndexOf("data-", 0) ? a.setAttribute(d, c) : a[d] = c }) },
        Qa = {
        ...
        Sa = function(a, b, c, d) {
            ...
            for (; d < c.length; d++) {
                ...
                if (!la(f) || ma(f) && 0 < f.nodeType) e(f);
                    ...
                    a: {
                        if (f && "number" == typeof f.length) { if (ma(f)) { var g = "function" == typeof f.item || "string" == typeof f.item; break a } if ("function" === typeof f) { g = "function" == typeof f.item; break a } }
                        g = !1
                    }
                    Ba(g ? Ca(f) : f, e)
                }
        ...
        Ta = function(a, b) { b = String(b); "application/xhtml+xml" === a.contentType && (b = b.toLowerCase()); return a.createElement(b) },
        Ua =
        function(a) { ya(a, "Node cannot be null or undefined."); return 9 == a.nodeType ? a : a.ownerDocument || a.document },
        Va = function(a) { this.C = a || t.document || document };
    n = Va.prototype;
    ...
    n.ga = function(a, b, c) {
        var d = this.C,
            ...
            f = e[1],
            g = Ta(d, String(e[0]));
        f && ("string" === typeof f ? g.className = f : Array.isArray(f) ? g.className = f.join(" ") : Ra(g, f));
        2 < e.length && Sa(d, g, e, 2);
        return g
    };
    n.createElement = function(a) { return Ta(this.C, a) };
    ...
    n.append = function(a, b) { Sa(Ua(a), a, arguments, 1) };
    ...
    var A = window,
        ...
        eb = /"/g,
        fb = /'/g,
        gb = function(a) { return String(a).replace(bb, "&amp;").replace(cb, "&lt;").replace(db, "&gt;").replace(eb, "&quot;").replace(fb, "&#39;") },
        D = function() {
            var a;
            if ((a = Object.create) &&
                Ya.test(a)) a = a(null);
        ...
        ib = function(a) { return function() { A.setTimeout(a, 0) } },
    ...
    var J = function(a, b, c) {
        ...
        ob = function(a) {
            a = String(a);
            a = a.replace(kb, function(e) { try { return encodeURIComponent(e) } catch (f) { return encodeURIComponent(e.replace(/^[^%]+$/g, "\ufffd")) } }).replace(lb, function(e) { return e.replace(/%/g, "%25") }).replace(mb, function(e) { return e.toUpperCase() });
            a = a.match(jb) || [];
            var b = D(),
                c = function(e) {
        ...
        pb = function(a) { return a.B + (0 < a.query.length ? "?" + a.query.join("&") : "") + (0 < a.j.length ? "#" + a.j.join("&") : "") },
        qb = function(a, b) {
            var c = [];
            if (a)
                for (var d in a)
        ...
        tb = function(a, b) {
            ...
            b instanceof Oa && b.constructor === Oa ? b = b.O : (za("expected object of type SafeHtml, got '" + b + "' of type " + ka(b)), b = "type_error:SafeHtml");
            e.innerHTML = b;
    ...
    var wb = function(a, b, c, d) {
        ...
        xb = function() { var a = B.readyState; return "complete" === a || "interactive" === a && -1 == navigator.userAgent.indexOf("MSIE") },
        Ab = function(a) {
            var b = yb;
            if (!xb()) try { b() } catch (c) {}
            zb(a)
        ...
        zb = function(a) {
            if (xb()) a();
                ...
                A.addEventListener ? (A.addEventListener("load", c, !1), A.addEventListener("DOMContentLoaded", c, !1)) : A.attachEvent &&
                    (A.attachEvent("onreadystatechange", function() { xb() && c.apply(this, arguments) }), A.attachEvent("onload", c))
            }
        },
        Bb = function(a) { for (; a.firstChild;) a.removeChild(a.firstChild) },
        Cb = { button: !0, div: !0, span: !0 };
    var L = {};
    L = C(A, "___jsl", D());
    C(L, "I", 0);
    C(L, "hel", 10);
    var Db = function(a) { return L.dpo ? L.h : J(a, "jsh", L.h) },
        Eb = function(a) {
            var b = C(L, "sws", []);
            b.push.apply(b, a)
        },
        Fb = function(a) { return C(L, "watt", D())[a] },
        Gb = function(a) {
            var b = C(L, "PQ", []);
            L.PQ = [];
            var c = b.length;
        ...
        Hb = function(a) { return C(C(L, "H", D()), a, D()) };
    var Ib = C(L, "perf", D()),
        Jb = C(Ib, "g", D()),
        Kb = C(Ib, "i", D());
    C(Ib, "r", []);
    D();
    D();
    var Lb = function(a, b, c) { var d = Ib.r; "function" === typeof d ? d(a, b, c) : d.push([a, b, c]) },
        Mb = function(a, b) {
            Jb[a] = !b && Jb[a] || (new Date).getTime();
            Lb(a)
        },
        Ob = function(a, b, c) { b && 0 < b.length && (b = Nb(b), c && 0 < c.length && (b += "___" + Nb(c)), 28 < b.length && (b = b.substr(0, 28) + (b.length - 28)), c = b, b = C(Kb, "_p", D()), C(b, c, D())[a] = (new Date).getTime(), Lb(a, "_p", c)) },
        Nb = function(a) { return a.join("__").replace(/\./g, "_").replace(/\-/g, "_").replace(/,/g, "_") };
    var Pb = D(),
        M = [],
        N = function(a) { throw Error("Bad hint: " + a); };
    ...
    var cc = decodeURI("%73cript"),
        ...
        lc = function(a, b, c) {
            ...
            var r = C(Hb(c), "L", []).sort(),
                ...
                I = function(P, ea) {
                    ...
                    if (ea) { Ob("me0", P, p); try { kc(ea, c, k) } finally { Ob("me1", P, p) } }
                    return 1
                };
        ...
        hc = ua("gapi#gapi");
    var jc = function(a, b) { if (L.hee && 0 < L.hel) try { return a() } catch (c) { b && b(c), L.hel--, mc("debug_error", function() { try { window.___jsl.hefn(c) } catch (d) { throw c; } }) } else try { return a() } catch (c) { throw b && b(c), c; } };
    var nc = H.load;
    nc && C(L, "ol", []).push(nc);
    H.load = function(a, b) { return jc(function() { return mc(a, b) }) };
    var oc = function(a) {
        ...
        qc = function(a) { return "object" === typeof a && /\[native code\]/.test(a.push) },
        O = function(a, b, c) {
        ...
        rc = function(a) { if (a && !/^\s+$/.test(a)) { for (; 0 == a.charCodeAt(a.length - 1);) a = a.substring(0, a.length - 1); try { var b = window.JSON.parse(a) } catch (c) {} if ("object" === typeof b) return b; try { b = (new Function("return (" + a + "\n)"))() } catch (c) {} if ("object" === typeof b) return b; try { b = (new Function("return ({" + a + "\n})"))() } catch (c) {} return "object" === typeof b ? b : {} } },
        sc = function(a, b) {
            var c = { ___goc: void 0 };
    ...
    var wc = { callback: 1, clientid: 1, cookiepolicy: 1, openidrealm: -1, includegrantedscopes: -1, requestvisibleactions: 1, scope: 1 },
        ...
        zc = function() {
            if (!xc) {
                ...
                if (window.self !== window.top) { a = document.location.toString(); for (var e in wc) 0 < wc[e] && (b = J(a, e, "")) && (yc[e] = b) }
                xc = !0
            }
            e = D();
            F(yc, e);
    ...
    var Bc = function() { this.i = window.console };
    Bc.prototype.log = function(a) { this.i && this.i.log && this.i.log(a) };
    Bc.prototype.error = function(a) { this.i && (this.i.error ? this.i.error(a) : this.i.log && this.i.log(a)) };
    Bc.prototype.warn = function(a) { this.i && (this.i.warn ? this.i.warn(a) : this.i.log && this.i.log(a)) };
    Bc.prototype.debug = function() {};
    var Cc = new Bc;
    var Dc = function() { return !!L.oa },
        Ec = function() {};
    var R = C(L, "rw", D()),
        Fc = function(a) { for (var b in R) a(R[b]) },
        Gc = function(a, b) {
    ...
    var Lc, T, U = void 0,
        V = function(a) { try { return t.JSON.parse.call(t.JSON, a) } catch (b) { return !1 } },
        ...
        jd = function() {
            ...
            if ((void 0 === Lc || void 0 === U || T !== a) && -1 !== T) {
                ...
                T = -1;
                try {
                    try { U = !!t.JSON && '{"a":[3,true,"1970-01-01T00:00:00.000Z"]}' === t.JSON.stringify.call(t.JSON, { a: [3, !0, new Date(0)], c: function() {} }) && !0 === V("true") && 3 === V('[{"a":3}]')[0].a } catch (b) {}
                    Lc = U && !V("[00]") &&
                        !V('"\u0007"') && !V('"\\0"') && !V('"\\v"')
                } finally { T = a }
            }
        ...
        ld = function(a) { if (-1 !== T) return jd(), U ? t.JSON.stringify.call(t.JSON, a) : X(a) },
    ...
    var od = function() { this.blockSize = -1 };
    var pd = function() {
        this.blockSize = -1;
        this.blockSize = 64;
        this.g = [];
    ...
    var rd = function() { this.R = new pd };
    rd.prototype.reset = function() { this.R.reset() };
    var sd = A.crypto,
        td = !1,
        ud = 0,
        vd = 0,
    ...
    td || (xd = 1E6 * (screen.width * screen.width + screen.height), yd = Ad(B.cookie + "|" + B.location + "|" + (new Date).getTime() + "|" + Math.random()), ud = S("random/maxObserveMousemove") || 0, 0 != ud && wb("mousemove", zd, "add", "at"));
    var Bd = function() {
            var a = L.onl;
            if (!a) {
                a = D();
        ...
        Cd = function(a, b) { b = b.onload; return "function" === typeof b ? (Bd().a(a, b), b) : null },
        Dd = function(a) { G(/^\w+$/.test(a), "Unsupported id - " + a); return 'onload="window.___jsl.onl.e(&#34;' + a + '&#34;)"' },
        Ed = function(a) { Bd().r(a) };
    var Fd = { allowtransparency: "true", frameborder: "0", hspace: "0", marginheight: "0", marginwidth: "0", scrolling: "no", style: "", tabindex: "0", vspace: "0", width: "100%" },
        ...
        Hd = 0,
        Id = function(a) { G(!a || ub.test(a), "Illegal url for new iframe - " + a) },
        Jd = function(a, b, c, d, e) {
            Id(c.src);
            var f, g = Cd(d, c),
                h = g ? Dd(d) : "";
            try { document.all && (f = a.createElement('<iframe frameborder="' + gb(String(c.frameborder)) + '" scrolling="' + gb(String(c.scrolling)) + '" ' + h + ' name="' + gb(String(c.name)) + '"/>')) } catch (l) {} finally {
                f ||
                    (f = (a ? new Va(Ua(a)) : va || (va = new Va)).ga("IFRAME"), g && (f.onload = function() {
                        f.onload = null;
                        g.call(this)
                    }, Ed(d)))
            }
    ...
    var Kd = /^:[\w]+$/,
        ...
        Md = function() {
            ...
            return vb = { socialhost: f, ctx_socialhost: d ? g : f, session_index: a, session_delegate: b, session_prefix: c, im_prefix: e }
        },
        Nd = function(a, b) { return Md()[b] || "" },
        Od = function(a) {
            return function(b,
                c) { return a ? Md()[c] || a[c] || "" : Md()[c] || "" }
        };
    var Pd = function(a) {
            var b;
    ...
    var Rd = { se: "0" },
        ...
        Wd = function(a, b, c) {
            ...
            m = [].concat(Ud);
            (l = Q("iframes/" + a + "/methods")) && "object" === typeof l && Ya.test(l.push) && (m = m.concat(l));
        ...
        Yd = function(a) { var b = void 0; "number" === typeof a ? b = a : "string" === typeof a && (b = parseInt(a, 10)); return b },
        be = function() {
            var a = L.drw;
            Fc(function(b) {
        ...
        $d = function(a) { var b = RegExp("(\\?|&)ic=1"); return a.replace(/#.*/, "").replace(b, "") };
    ...
    ee = C(L, "FW", []);
    fe = null;
    var ie = function(a, b) { return ("string" === typeof a ? document.getElementById(a) : a) || b },
        ke = function(a, b) { je(void 0, !1, a, b) },
        je = function(a, b, c, d) {
            Mb("ps0", !0);
            c = ie(c, B);
            ...
            for (f = 0; f < e.length; f++) {
                ...
                if (k.getAttribute("data-gapiscan")) h =
                    ...
                    var r = l.indexOf("g:");
                    0 == r ? m = l.substr(2) : (r = (r = String(k.className || k.getAttribute("class"))) && ge.exec(r)) && (m = r[1]);
                    h = !m || !(ce[m] || de[m] || Y[m]) || h && m !== h ? null : m
                }
                h && (he[h] || 0 == g.nodeName.toLowerCase().indexOf("g:") || 0 != hb(Zd(g)).length) && (g.setAttribute("data-gapiscan", !0), C(c, h, []).push(g))
            }
            if (b)
                for (var u in c)
            ...
            Mb("ps1", !0);
            if ((u = ee.join(":")) || a) try { H.load(u, a) } catch (y) { Cc.log(y); return }
            if (le(fe || {}))
                for (var I in c) {
                    a = c[I];
                    p = 0;
                    ...
                    d = [];
                    for (I in c)
                        for (a = c[I], p = 0, b = a.length; p < b; p++) e = a[p], ne(I, e, Zd(e), d, b);
                    oe(u, d)
                }
        },
        pe = function(a) {
            var b = C(H, a, {});
            b.go || (b.go = function(c) { return ke(c, a) }, b.render = function(c, d) {
                d = d || {};
                d.type = a;
                return ae(c, d)
            })
        },
        qe = function(a) { ce[a] = !0 },
        ...
        ne = function(a, b, c, d, e, f) {
            switch (te(b, a, f)) {
                ...
                case 1:
                    if (b.parentNode) {
                        for (var g in c) {
                            if (f = E(c, g)) f = c[g], f = !!f && "object" === typeof f && (!f.toString || f.toString === Object.prototype.toString || f.toString === Array.prototype.toString);
                            if (f) try { c[g] = ld(c[g]) } catch (K) { delete c[g] }
                        }
                        var h = !0;
                        c.dontclear && (h = !1);
                        delete c.dontclear;
                        ...
                        e.siteElement =
                            k;
                        k.id || (b = k, C(Vd, a, 0), h = "___" + a + "_" + Vd[a]++, b.id = h);
                        b = D();
                        b[">type"] = a;
                        F(c, b);
                        h = f;
                        ...
                        f = g || {};
                        b = f.attributes || {};
                        G(!(f.allowPost || f.forcePost) || !b.onload, "onload is not supported by post iframe (allowPost or forcePost)");
                        g = b = h;
                        Kd.test(b) && (g = S("iframes/" + g.substring(1) + "/url"), G(!!g, "Unknown iframe url config for - " + b));
                        h = tb(B, g.replace(Ld, Nd));
                        b = c.ownerDocument || B;
                        g = f;
                        var l = 0;
                        do k = g.id || ["I", Hd++, "_", (new Date).getTime()].join(""); while (b.getElementById(k) && 5 > ++l);
                        ...
                        var r = k.pfname;
                        var u = D();
                        S("iframes/dropLegacyIdParam") || (u.id = g);
                        u._gfid = g;
                        u.parent = b.location.protocol + "//" + b.location.host;
                        var p = J(b.location.href, "parent");
                        r = r || "";
                        !r && p && (p = J(b.location.href, "_gfid", "") || J(b.location.href, "id", ""), r = J(b.location.href, "pfname", ""), r = p ? r + "/" + p : "");
                        r || (p = kd(J(b.location.href, "jcp", ""))) && "object" == typeof p && (r = (r = p.id) ? p.pfname +
                            "/" + r : "");
                        u.pfname = r;
                        k.connectWithJsonParam && (p = {}, p.jcp = ld(u), u = p);
                        p = J(h, "rpctoken") || l.rpctoken || m.rpctoken;
                        if (!p) {
                            if (!(p = k.rpctoken)) {
                                p = String;
                                r = Math;
                        ...
                        if (f.forcePost || h && 2E3 < l.length) {
                            ...
                            g = l instanceof z ? l : Ma(l);
                            Pa(h, "HTMLFormElement").action = Ka(g);
                            for (g = 0; g < k.length; g++) l = b.createElement("input"), l.type = "hidden", l.name = k[g][0], l.value = k[g][1], h.appendChild(l);
                            c.appendChild(h);
                            h.submit();
                    ...
                    v && ((e = v.id) && d.push(e), me(a, v))
            }
        },
        te = function(a, b, c) { if (a && 1 === a.nodeType && b) { if (c) return 1; if (Y[b]) { if (Cb[a.nodeName.toLowerCase()]) return (a = a.innerHTML) && a.replace(/^[\s\xa0]+|[\s\xa0]+$/g, "") ? 0 : 1 } else { if (de[b]) return 0; if (ce[b]) return 1 } } return null },
        ae = function(a, b) {
            var c = b.type;
            delete b.type;
            var d = ie(a);
    ...
    oe = function(a, b) { ue(a, b) };
    var yb = function(a) { je(a, !0) },
        ve = function(a, b) { b = b || []; for (var c = 0; c < b.length; ++c) a(b[c]); for (a = 0; a < b.length; a++) pe(b[a]) };
    ...
    var xe = /^\{h:'/,
        ...
        ze = "",
        ue = function(a, b) {
            function c() { wb("message", d, "remove", "de") }
            ...
            function d(f) {
                ...
                if (Ae(g, b)) {
                    ...
                    Be(a, function() {
                        k && Mb("rqd");
                        c();
                        for (var l = C(L, "RPMQ", []), m = 0; m < l.length; m++) l[m]({ data: g, origin: h })
                    })
                }
            }
            if (0 !== b.length) {
    ...
    Ce.prototype.read = function() { for (var a = this.N + "=", b = document.cookie.split(/;\s*/), c = 0; c < b.length; ++c) { var d = b[c]; if (0 == d.indexOf(a)) return d.substr(a.length) } };
    ...
    Ce.prototype.clear = function() { this.write("", 0) };
    var Ee = /^[-+/_=.:|%&a-zA-Z0-9@]*$/,
    ...
    var Fe = function(a) { this.G = a };
    Fe.prototype.read = function() { if (Z.hasOwnProperty(this.G)) return Z[this.G] };
    Fe.prototype.write = function(a) { Z[this.G] = a; return !0 };
    Fe.prototype.clear = function() { delete Z[this.G] };
    var Z = {};
    Fe.iterate = function(a) { for (var b in Z) Z.hasOwnProperty(b) && a(b, Z[b]) };
    var Ge = "https:" === window.location.protocol,
        ...
        Je = function() {
            var a, b = null;
            He.iterate(function(c, d) { 0 === c.indexOf("G_AUTHUSER_") && (c = Ie(c.substring(11)), !a || c.l && !a.l || c.l == a.l && c.o > a.o) && (a = c, b = d) });
            return { fa: a, K: b }
        };
    ...
    function Ke(a) {
        ...
        d = "E" === c && e.l;
        return !d && ("U" !== c || e.l) || d && !Ge ? b : { X: !0, l: d, ma: a.substr(1), domain: e.domain, o: e.o }
    }
    var Le = function(a) {
            if (!a) return [];
            a = a.split("=");
        ...
        Me = function(a) { a = a.split(":"); return { clientId: a[0].split("=")[1], ka: Le(a[1]), pa: Le(a[2]), na: Le(a[3]) } },
        Ne = function() {
            var a = Je(),
                b = a.fa;
            a = a.K;
    ...
    M.unshift(["url", function(a, b, c) {!a || b && "" !== b || !a.endsWith(".js") || (a = a.substring(0, a.length - 3), b = a.lastIndexOf("/") + 1, b >= a.length || (a = a.substr(b).split(":").filter(function(d) { return !["api", "platform"].includes(d) }), c.features = a)) }]);
    window.gapi.load("", {
        ...
        _c: {
            ...
            jsl: {
                ...
                h: "m;/_/scs/abc-static/_/js/k=gapi.lb.en.KVSPb_Y8pSk.O/d=1/rs=AHpOoo9gW8E5WGSmGcbq8d2kz7xJze20YQ/m=__features__",
