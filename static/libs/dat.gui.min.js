...
! function(e, t) {
	...
	function y(e) {
		...
		function n() {
			X.unbind(window, "mousemove", t), X.unbind(window, "mouseup", n)
		}

		function o(o) {
			return o.preventDefault(), i = o.clientX, X.bind(window, "mousemove", t), X.bind(window, "mouseup", n), !1
		}
		var i = void 0;
	}

	function w(e, t) {
		e.domElement.style.width = t + "px", e.__save_row && e.autoPlace && (e.__save_row.style.width = t + "px")
	}
		...
		he = function e(t) {
			...
			if (Object.defineProperties(this, {
					...
					closed: {
						...
						set: function(t) {
							o.closed = t, o.closed ? X.addClass(n.__ul, e.CLASS_CLOSED) : X.removeClass(n.__ul, e.CLASS_CLOSED), this.onResize()
						}
					},
					load: {
						get: function() {
